---
title: "Big Five Personality 201501"
author: "coop711"
date: "2015년 6월 2일"
...
```{r, echo = FALSE}
levels(BFI.MI.full$제1순위) <- levels(BFI.MI.full$제2순위)
levels(BFI.MI.full$제3순위) <- levels(BFI.MI.full$제2순위)
kable(t(sapply(BFI.MI.full[c("제1순위", "제2순위", "제3순위")], table)))
```
